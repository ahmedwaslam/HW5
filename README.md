...
Hypothesis Test for a Polynomial We did a F-test whether the relationship is cubic or quadratic. The F statistic is statistically significant, so we reject the null hypothesis, Therefore, the model has a cubic relationship.
